...
public class EditInPermissionForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clockInEditText.setText(clockInTime);
        ...
        updateButton.setOnClickListener(v -> {
            ...
            if (updatedUsername.isEmpty() || updatedDate.isEmpty() || updatedClockIn.isEmpty() || updatedUserEmail.isEmpty()) {
                Toast.makeText(EditInPermissionForm.this, "Please fill in all fields", Toast.LENGTH_SHORT).show();
            } else {
        ...
        userRef.child("email").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Log.d("EditInPermissionForm", "Stored Email: " + storedEmail);
                    ...
                    userRef.child("timeRecords").child(date).addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot timeRecordSnapshot) {
                            if (timeRecordSnapshot.exists()) {
                                ...
                                updates.put("ClockInTime", clockInTime); // Update the ClockInTime field
                                updates.put("ClockInTimestamp", System.currentTimeMillis()); // Update timestamp to current time
                                ...
                                userRef.child("timeRecords").child(date).updateChildren(updates)
                                        .addOnCompleteListener(task -> {
                                            if (task.isSuccessful()) {
                                                ...
                                                Toast.makeText(EditInPermissionForm.this, "Clock-in time updated successfully", Toast.LENGTH_SHORT).show();
                                                ...
                                                // Error in updating
                                                Toast.makeText(EditInPermissionForm.this, "Error updating clock-in time", Toast.LENGTH_SHORT).show();
                                            }
                                        });
                            } else {
                                // No record found for this date in timeRecords
                                Toast.makeText(EditInPermissionForm.this, "No record found for this date", Toast.LENGTH_SHORT).show();
                            }
                        }
                        ...
                        public void onCancelled(@NonNull DatabaseError databaseError) {
                            // Handle error
                            Toast.makeText(EditInPermissionForm.this, "Error accessing database", Toast.LENGTH_SHORT).show();
                        }
                    });
                } else {
                    // No user record found with this uid
                    Toast.makeText(EditInPermissionForm.this, "No user found with this UID", Toast.LENGTH_SHORT).show();
                }
            }
