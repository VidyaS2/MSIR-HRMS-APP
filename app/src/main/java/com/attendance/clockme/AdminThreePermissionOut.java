...
public class AdminThreePermissionOut extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clockOutPermissionRef = FirebaseDatabase.getInstance().getReference("ClockOutPermission");
        ...
        homeIcon.setOnClickListener(v -> {
            Intent intent = new Intent(AdminThreePermissionOut.this, DashboardActivity.class);
        ...
        logoutIcon.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(AdminThreePermissionOut.this, SignInActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
            startActivity(intent);

            // Optionally, show a message indicating the user has logged out
            Toast.makeText(AdminThreePermissionOut.this, "Logged out successfully", Toast.LENGTH_SHORT).show();
        });

        clockIcon.setOnClickListener(v -> {
            Intent clockInOutIntent = new Intent(AdminThreePermissionOut.this, SwipingTimeActivity.class);
            startActivity(clockInOutIntent);
        });

        // Set listener for requestIcon
        requestIcon.setOnClickListener(v -> {
            Intent salaryDetailsIntent = new Intent(AdminThreePermissionOut.this, SalaryDetailsActivity.class);
        ...
        clockOutPermissionRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                    ...
                    for (DataSnapshot dateSnapshot : uidSnapshot.getChildren()) { // Iterate over dates
                        ...
                        if (dataMap != null) {
                            ...
                            if (team.equals(dataTeam) && "pending".equalsIgnoreCase(status)) {
                                ...
                                CardView cardView = new CardView(AdminThreePermissionOut.this);
                                ...
                                LinearLayout permissionsLayout = new LinearLayout(AdminThreePermissionOut.this);
                                ...
                                LinearLayout buttonLayout = new LinearLayout(AdminThreePermissionOut.this);
                                ...
                                Button approveButton = new Button(AdminThreePermissionOut.this);
                                ...
                                Button rejectButton = new Button(AdminThreePermissionOut.this);
                ...
                if (!hasPendingRequests) {
                    ...
                    TextView noRequestsTextView = new TextView(AdminThreePermissionOut.this);
    ...
    private void updateClockOutPermissionStatus(String uid, String dateKey, String newStatus) {
        ...
        Toast.makeText(AdminThreePermissionOut.this, "Status updated to " + newStatus, Toast.LENGTH_SHORT).show();
    }
    ...
    private void updateUserClockOutData(String uid, String date, String clockOutTime, String clockOutLocation) {
        ...
        Toast.makeText(AdminThreePermissionOut.this, "User data updated with ClockOut details.", Toast.LENGTH_SHORT).show();
    }
    ...
    private TextView createTextView(String text) {
        TextView textView = new TextView(AdminThreePermissionOut.this);
