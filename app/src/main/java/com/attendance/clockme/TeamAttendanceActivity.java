...
public class TeamAttendanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createLayout = findViewById(R.id.clocklayout);
        ...
        homeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TeamAttendanceActivity.this, AdminThreeDashboard.class);
        ...
        createLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TeamAttendanceActivity.this, SwipingTimeActivity.class);
                startActivity(intent);
            }
        });
        ...
        requestLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TeamAttendanceActivity.this, SalaryDetailsActivity.class);
                startActivity(intent);
            }
        });
    ...
    private void fetchDailyAttendance() {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(TeamAttendanceActivity.this, "Error fetching data: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
