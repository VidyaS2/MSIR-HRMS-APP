...
public class AdminThreeCoffIn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("CoffHdPermission");
        ...
        homeIcon.setOnClickListener(v -> {
            Intent intent = new Intent(AdminThreeCoffIn.this, DashboardActivity.class);
        ...
        logoutIcon.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(AdminThreeCoffIn.this, SignInActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
            startActivity(intent);

            // Optionally, show a message indicating the user has logged out
            Toast.makeText(AdminThreeCoffIn.this, "Logged out successfully", Toast.LENGTH_SHORT).show();
        });

        clockIcon.setOnClickListener(v -> {
            Intent clockInOutIntent = new Intent(AdminThreeCoffIn.this, SwipingTimeActivity.class);
            startActivity(clockInOutIntent);
        });

        // Set listener for requestIcon
        requestIcon.setOnClickListener(v -> {
            Intent salaryDetailsIntent = new Intent(AdminThreeCoffIn.this, SalaryDetailsActivity.class);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                    ...
                    for (DataSnapshot dateSnapshot : uidSnapshot.getChildren()) { // Iterate over dates
                        ...
                        if (dataMap != null) {
                            ...
                            if (team.equals(dataTeam) && "pending".equalsIgnoreCase(status)) {
                                ...
                                CardView cardView = new CardView(AdminThreeCoffIn.this);
                                ...
                                LinearLayout permissionsLayout = new LinearLayout(AdminThreeCoffIn.this);
                                ...
                                LinearLayout buttonLayout = new LinearLayout(AdminThreeCoffIn.this);
                                ...
                                Button approveButton = new Button(AdminThreeCoffIn.this);
                                ...
                                Button rejectButton = new Button(AdminThreeCoffIn.this);
                ...
                if (!hasPendingRequests) {
                    TextView noRequestsTextView = new TextView(AdminThreeCoffIn.this);
    ...
    private void updateClockInPermissionStatus(String uid, String dateKey, String newStatus) {
        ...
        Toast.makeText(AdminThreeCoffIn.this, "Status updated to " + newStatus, Toast.LENGTH_SHORT).show();
    }
    ...
    private void updateUserClockInData(String uid, String date, String clockInTime, String clockInLocation) {
        ...
        Toast.makeText(AdminThreeCoffIn.this, "User data updated with ClockIn details.", Toast.LENGTH_SHORT).show();
    }
    ...
    private TextView createTextView(String text) {
        TextView textView = new TextView(AdminThreeCoffIn.this);
