...
public class AdminRelieveHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_relieve_history);

        // Initialize Firebase reference for RelieveRequests node
        relieveRequestsRef = FirebaseDatabase.getInstance().getReference("RelieveRequest");

        // Initialize TableLayout
        dynamicRowContainer = findViewById(R.id.dynamicRowContainer);

        // Fetch relieve request data
        fetchRelieveRequests();
        ...
        homeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AdminRelieveHistoryActivity.this, ActivityAdminDashboard.class);
        ...
        createLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdminRelieveHistoryActivity.this, EmpRegActivity.class);
                startActivity(intent);
            }
        });
        ...
        requestLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdminRelieveHistoryActivity.this, AdminDailyAttendanceActivity.class);
                startActivity(intent);
            }
        });
    ...
    private void fetchRelieveRequests() {
        relieveRequestsRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    addRowToTable(username, position, date, reason, status);
                }
            }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                // Handle error
                Toast.makeText(AdminRelieveHistoryActivity.this, "Failed to load data.", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void addRowToTable(String username, String position, String date, String reason, String status) {
