...
public class CoffHdOutFormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coff_out_form);
        ...
        tvClockInTime.setText(currentClockOutTime);
        ...
        btnSubmit.setOnClickListener(v -> {
            ...
            if (remark.isEmpty()) {
                Toast.makeText(CoffHdOutFormActivity.this, "Please enter a remark", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            String clockOutLocation = tvClockInLocation.getText().toString();
            String clockInKey = new SimpleDateFormat("dd-MM-yyyy", Locale.getDefault()).format(new Date());

            if (selectedTeam.equals("Select Team")) {
                Toast.makeText(CoffHdOutFormActivity.this, "Please select a valid team", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            databaseReference.child("Users").child(uid).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()) {
                        ...
                        permissionData.put("clockInTime", currentClockOutTime);
                        ...
                        permissionData.put("clockInLocation", clockOutLocation);
                        permissionData.put("team", selectedTeam);

                        // Ensure this points to CoffHdPermission
                        databaseReference.child("CoffHdOutPermission").child(uid).child(clockInKey)
                                .setValue(permissionData)
                                .addOnCompleteListener(task -> {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(CoffHdOutFormActivity.this, "Permission request submitted", Toast.LENGTH_SHORT).show();
                                        finish();
                                    } else {
                                        Toast.makeText(CoffHdOutFormActivity.this, "Submission failed", Toast.LENGTH_SHORT).show();
                                    }
                                });
                    }
                }
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    Toast.makeText(CoffHdOutFormActivity.this, "Error fetching user details", Toast.LENGTH_SHORT).show();
                }
            });
        });
    ...
    private void fetchCurrentLocation() {
        ...
        fusedLocationProviderClient.getLastLocation().addOnSuccessListener(this, location -> {
            if (location != null) {
                Geocoder geocoder = new Geocoder(CoffHdOutFormActivity.this, Locale.getDefault());
                try {
